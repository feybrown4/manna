        ...
        <div class="sidebar bg-light pe-4 pb-3">
            <nav class="navbar">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="manage_fruit.php" class="nav-item nav-link"><i class="fa fa-carrot me-2"></i>Fruits</a>
                    <a href="manage_order.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Order</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
